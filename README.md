...
- **`tasks list` / `tasks search` bounded defaults** — by default, these commands fetch up to 2 pages and return `pages_fetched`, `results_complete`, and `results_truncated`. Use `--all-pages` for an exhaustive scan.
